...
$prodOrigin = "https://bonerablaise.github.io"
$passed = 0
$failed = 0
$warned = 0
...
$oauthOut = curl.exe -s -o NUL -w "%{http_code}" "https://yebone-backend.onrender.com/api/v2/auth/google?redirect=https://bonerablaise.github.io/yebo-marketplace/login-success"
