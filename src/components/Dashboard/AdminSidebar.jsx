...
export const ADMIN_NAV_PLATFORM = [
  { id: 36, label: "Platform Config", to: "/admin/platform-configuration", icon: HiOutlineAdjustments },
  { id: 20, label: "Payment Center", to: "/admin/dashboard", hash: "#admin-payments", icon: HiOutlineCurrencyDollar },
  { id: 21, label: "Commission", to: "/admin/commission", icon: HiOutlineChartBar },
  { id: 22, label: "Referrals", to: "/admin/referrals", icon: HiOutlineReceiptRefund },
  { id: 23, label: "AI Control", to: "/admin/ai", icon: HiOutlineSparkles },
  { id: 27, label: "Delivery", to: "/admin/delivery", icon: HiOutlineTruck },
  { id: 28, label: "Growth", to: "/admin/growth", icon: HiOutlineTrendingUp },
  { id: 29, label: "Commission Rules", to: "/admin/commission-rules", icon: HiOutlineClipboardList },
  { id: 30, label: "Coupons", to: "/admin/coupons", icon: HiOutlineTicket },
  { id: 35, label: "Banners", to: "/admin/banners", icon: HiOutlinePhotograph },
  { id: 37, label: "Config History", to: "/admin/history", icon: HiOutlineClock },
  { id: 38, label: "Feature Flags", to: "/admin/feature-flags", icon: HiOutlineFlag },
...
export const ADMIN_TITLES = {
  ...
  20: "Payment Center",
  21: "Commission Center",
  22: "Referral Center",
  23: "AI Control Center",
  27: "Delivery Control Center",
  28: "Growth Center",
  29: "Commission Rules",
  30: "Coupon Center",
  31: "Growth Commerce",
